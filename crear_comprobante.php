...
<?php 
    ...
    if (isset($haycantidad_existencia) && $haycantidad_existencia=="no") {
    ...
    if (isset($_SESSION['hay_cantidad_existencia_b']) && $_SESSION['hay_cantidad_existencia_b']=="no") {

    	unset($_SESSION['hay_cantidad_existencia_b']);
