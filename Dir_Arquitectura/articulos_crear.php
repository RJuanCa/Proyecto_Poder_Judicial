...
<meta charset="utf-8">
<title>Dir. de Arquitectura - Producto - Ingresar - Form</title>
...
<nav class="navbar navbar-default">
  <div class="container"> 
    ...
    <div class="navbar-header">
      ...
      <p class="navbar-brand"><span class="menu2"><a href="articulos.php">Volver</a></span></p> 
  ...
  <h4>Crear Producto</h4>
    ...
    <form id="formulario_producto" class="form-horizontal" method="post" action="return false" onsubmit="return false">
      ...
      <div class="form-group">
        <label for="producto" class="control-label col-md-2">Artículo:</label>
        <div class="col-md-9">
