...
<head>
<meta charset="utf-8">	
<title>Dir. de Arquitectura - Proveedores - Lista</title>
...
<div class="row"><div class="col-lg-6"></div>
  <div class="col-lg-6">
    <div class="input-group">
      <input type="text" class="form-control" placeholder="Buscar..."  name='search[keyword]' value="<?php echo $search_keyword; ?>" id='keyword' maxlength='25'>
...
<table class="table table-bordered table-hover">
  <thead>
	<tr class='th_color'>
	  ...
	  <th class='table-header' width='30%'>Nombre Comercio</th>
	  <th class='table-header' width='30%'>Direeción</th>
	  <th class='table-header' width='14%'>CUIT</th>
  ...
  <tbody id='table-body'>
	...
	?>
	  <tr class='table-row'>
		...
		<td><?php echo $row['dereccion']; ?></td>
		<td><?php echo $row['cuil']; ?></td>
		<td>
      
      <a href="proveedores_reporte.php?id_proveedor=<?php echo $row['id_proveedor']?>">Ver| </a>
