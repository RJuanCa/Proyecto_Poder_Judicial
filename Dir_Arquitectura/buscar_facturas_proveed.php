...
<head>
<meta charset="utf-8">
<title>Dir. de Arquitectura - Facturas - Proveedores - Lista</title>
...
<div class="container">
   <p class="usuario3">
	...
	<br/>
	<b>CUIT:</b> <?php /* echo $_SESSION['cuit_proveed']; */ ?>
	<br/>
...
<p><span class="encab"><a href="ingresar_proveed_factura_nro.php">Ingresar Factura</a></span></p>
<table class="table table-bordered table-hover">
  <thead>
	<tr class='th_color'>
	  
	  <th class='table-header' width='22%'>Nro. Factura</th>
