...
<meta charset="utf-8">
<title>Dir. de Arquitectura - Proveedores - Editar - Form</title>
    ...
    <form id="formulario_proveedor" class="form-horizontal" method="post" action="return false" onsubmit="return false">
      ...
      <div class="form-group">
        ...
        <div class="col-md-1">
            ...
            <input id="nac" style="width:38px" class="form-control" type="text" name="nac" size="2" maxlength="2" autofocus value="<?php /* echo $nac */ ?>"/>
            <span class="input-group-addon">-</span>
            <input id="cedula" style="width:130px" class="form-control" type="text" name="cuit" size="20" maxlength="20" value="<?php /* echo $cuit */ ?>"/>
            <span class="input-group-addon">-</span>
      ...
      <div class="form-group">
        <label for="nombre_comercial" class="control-label col-md-2">Nombre Comercial:</label>
        <div class="col-md-9">
          <input id="nombre_comercial" class="form-control" type="text" name="nombre_comercial" size="20" maxlength="20" value="<?php /* echo $nombre_comercial */ ?>"/>
        </div>
      </div>
