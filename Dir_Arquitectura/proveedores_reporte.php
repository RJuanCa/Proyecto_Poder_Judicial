...
<meta charset="utf-8">
<title>
  dir. de Arquitectura - Proveedor - Vista</title>
...
<div class="form-horizontal">
  ...
  <div class="form-group">
    ...
    <span class="clientelabel">CUIT:</span>
    <span class="clientedato"><?php /* echo $row2['ciut'] */ ?></span>
    <br/>

    <span class="clientelabel">Nombre Comercio:</span>
    <span class="clientedato"><?php /* echo utf8_decode($row2['nombre_comercio']) */ ?></span>
    <br/>

    <span class="clientelabel">Comercio:</span>
    <span class="clientedato"><?php /* echo utf8_decode($row2['comercio']) */ ?></span>
    <br/>
