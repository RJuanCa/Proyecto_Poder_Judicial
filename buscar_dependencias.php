...
<table class="table table-bordered table-hover">
  ...
  <tbody id='table-body'>
	...
	?>
      ...
      <a href="dependencia_reporte.php?id_dependencia=<?php /* echo $row['id_dependencia']*/?>">Ver| </a>
      <a href="#" onclick="Validar3(<?php /* echo $row['id_dependencia']*/ ?>, '<?php /* echo $row['nombres'] */ ?>')">Editar| </a>
      <a href="#" onclick="Validar4(<?php /* echo $row['id_dependencia'] */?>, '<?php /* echo $row['nombres'] */ ?>')">Eliminar| </a>
...
// Editar dependencia
function Validar3(id_dependencia, nombres)
{

$.confirm({
title: 'Mensaje',
content: '¿Confirma en editar <br/> la dependencia '+nombres+'?',
animation: 'scale',
closeAnimation: 'zoom',
buttons: {
    confirm: {
        ...
        btnClass: 'btn-orange',
           ...
           window.location.href="dependencias_editar.php?id_dependencia="+id_dependencia;           
...
function Validar4(id_dependencia, nombres)
{

$.confirm({
title: 'Mensaje',
content: '¿Confirma en eliminar <br/> la dependencia '+nombres+'?',
animation: 'scale',
closeAnimation: 'zoom',
buttons: {
    confirm: {
        ...
        btnClass: 'btn-orange',
           ...
           window.location.href="dependencia_eliminar_validar.php?id_dependencia="+id_dependencia;           
